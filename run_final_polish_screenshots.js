...
const OUT_DIR = 'C:/Users/lenovo/.gemini/antigravity-cli/brain/0cb06c49-7fa4-478d-8b85-012236322047/screenshots/final_polish';
...
(async () => {
  console.log('Starting final polish visual verification...');
  ...
  try {
    ...
    await browser.close();
    console.log('Visual verification finished.');
  }
})();
