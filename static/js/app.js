(function () {
  ...
  function initLandingMedia() {
    const configEl = document.getElementById("landing-mode-config");
    if (!configEl) return;

    const mode = configEl.getAttribute("data-mode");
    if (mode === "IMAGE_STORY") {
      initImageStory();
    }
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Unified landing media modes (VIDEO_SCRUB / IMAGE_STORY)
    initLandingMedia();
